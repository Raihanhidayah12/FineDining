    ...
    <div class="row py-5">
      ...
      <div class="col-md-2 mb-4 mb-md-0">
        ...
        <ul class="list-unstyled">
          <li><a href="/pages/menu.php?category=Makanan&page=1#menu" class="footer-link">Foods</a></li>
          <li><a href="/pages/menu.php?category=Minuman&page=1#menu" class="footer-link">Drink</a></li>
          <li><a href="/pages/menu.php?category=Dessert&page=1#menu" class="footer-link">Dessert</a></li>
        </ul>
      </div>
      ...
      <div class="col-md-3 mb-4 mb-md-0">
        ...
        <ul class="list-unstyled">
          <li><a class="footer-link <?php echo $current_page == 'index.php' ? 'active' : ''; ?>" href="index.php">Home</a></li>
          <li><a class="footer-link <?php echo ($current_page == 'index.php' && isset($_GET['section']) && $_GET['section'] == 'seating-experiences') ? 'active' : ''; ?>" href="index.php#seating-experiences">Seating</a></li>
        </ul>
      </div>
